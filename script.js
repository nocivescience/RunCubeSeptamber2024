...
Player.prototype.draw = function () {
    ...
    InfiniteRunner.fillRect(this.x, this.y+Math.random()*10, this.width, this.height);
};
...
Particle.prototype.update = function () {
    this.x += this.velocityX+Math.random();
    this.y += this.velocityY;
    this.size *= 0.89;
};

Particle.prototype.draw = function () {
    InfiniteRunner.randomSeed = Math.random();
    console.log(InfiniteRunner.randomSeed);
    InfiniteRunner.fillStyle = InfiniteRunner.randomSeed>.4?this.color:'yellow';
